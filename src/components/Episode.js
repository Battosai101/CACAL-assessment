    ...
    return(
        <div className='relative font-[Outfit] w-full bg-[#1A1A1A] overflow-hidden'>
            <div className='relative flex items-center justify-between flex-wrap'>
                <motion.h1 initial={{opacity:0}} animate={{opacity:1}} transition={{delay:0.5, duration:0.5}} className='text-white font-bold text-[34px] leading-[43px] mt-14 ml-[89px] shrink-0'>
                    Trending <span className='text-[#FBC94A]'>this week</span>
                </motion.h1>
                <input type="search" placeholder="Search..." className='self-end mr-[90px] rounded-lg px-3 py-1 bg-[#106580] text-[#FBC94A] ml-[89px]' onChange={(e) => setTrendValue(e.target.value)} />
            </div>
            ...
            <div className='relative flex items-center justify-between flex-wrap'>
                ...
                <input type="search" placeholder="Search..." className='self-end mr-[90px] rounded-lg px-3 py-1 bg-[#FBC94A] text-[#106580] ml-[89px]' onChange={(e) => setThrowValue(e.target.value)} />
            </div>
