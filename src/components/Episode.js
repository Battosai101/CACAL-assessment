...
export default function Episode(){
    return(
        <div className='relative font-[Outfit] border-2 border-red-500 w-full pb-14 bg-[#1A1A1A]'>
            ...
            <div className='text-white flex items-center mt-[26px] px-[90px] space-x-4 overflow-auto scrollbar-hide scroll-smooth snap-x'>
                <TrendCard />
                <TrendCard />
                <TrendCard />
                <TrendCard />
            ...
            <div className='mt-9 flex items-center border-2 border-yellow-500 px-[90px] space-x-4 overflow-auto'>
                <ThrowCard />
                <ThrowCard />
                <ThrowCard />
            </div>
